...
private
  ...
  def recipe_params
    params.require(:recipe).permit(:name, :prep_time_in_minutes, :cook_time_in_minutes, :instructions)
  end

  def recipe_ingredient_params
    params.require(:recipe).permit(recipe_ingredients_attributes: [:quantity, ingredient: [:name]])
  end
